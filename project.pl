...
lpg(X,alc):-M is 0.01*X, write('LPG:'),write(' '),
    write(M),write(' '),write('litre'),nl.

gasolin(X,alc):-M is 0.12*X, write('Gasolin:'),write(' '),
    write(M),write(' '),write('litre'),nl.

kerosene(X,alc):-M is 0.22*X, write('Kerosene:'),write(' '),
    write(M),write(' '),write('litre'),nl.

diesel(X,alc):-M is 0.21*X, write('Diesel:'),write(' '),
    write(M),write(' '),write('litre'),nl.
residue(X,alc):- M is 0.411*X , write('Residue:'), write(' '), write(M), write(' '), write('litre'),nl.


lpg(X,murban):-M is 0.01*X, write('LPG:'),write(' '),
    write(M),write(' '),write('litre'),nl.

gasolin(X,murban):-M is 0.182*X, write('Gasolin:'),write(' '),
    write(M),write(' '),write('litre'),nl.

kerosene(X,murban):-M is 0.26*X, write('Kerosene:'),write(' '),
    write(M),write(' '),write('litre'),nl.

diesel(X,murban):-M is 0.209*X, write('Diesel:'),write(' '),
    write(M),write(' '),write('litre'),nl.

residue(X,murban):- M is  0.311*X , write('Residue:'), write(' '), write(M), write(' '), write('litre'),nl.
